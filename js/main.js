(function ($) {
    ...
    // Palette UX: Accessibility & Keyboard shortcuts
    const isID = $('html').attr('lang') === 'id';
    const labels = {
        sidebar: isID ? 'Tampilkan/Sembunyikan Sidebar' : 'Show/Hide Sidebar',
    ...
    // Add shortcuts hint and a11y attributes
