(function ($) {
    ...
    // Add keyboard hint to search placeholders
    ...
    $(document).on('keydown', function (e) {
        if (e.key === '/' && !$(e.target).closest('input, textarea, select, [contenteditable="true"]').length) {
    ...
    // Re-check when dropdowns or other dynamic content might be added
